...
export function normalizeAdminUiCopy(raw: unknown): AdminUiCopy {
  ...
  const labels: AdminNavCopy['labels'] = {
    ...
    sultan_catalog: uiText(labelsRaw.sultan_catalog),
    sultan_content: uiText(labelsRaw.sultan_content),
  ...
  const items: AdminNavCopy['items'] = {
    ...
    sultan_products: uiText(itemsRaw.sultan_products),
    sultan_categories: uiText(itemsRaw.sultan_categories),
    sultan_gallery: uiText(itemsRaw.sultan_gallery),
    sultan_offers: uiText(itemsRaw.sultan_offers),
    sultan_news: uiText(itemsRaw.sultan_news),
    sultan_news_comments: uiText(itemsRaw.sultan_news_comments),
    sultan_corporate: uiText(itemsRaw.sultan_corporate),
    sultan_legal: uiText(itemsRaw.sultan_legal),
    sultan_settings: uiText(itemsRaw.sultan_settings),
