...
-- Sultan Defense — site_settings (sultandefense__ prefix)
...
VALUES (
  ...
  'tr',
  JSON_OBJECT(
    'site_title',       'Sultan Defense | Güvenilir İnşaat ve Mimarlık Hizmetleri',
    'site_description', 'Konut, ticari ve karma kullanım projelerinde kaliteli, zamanında ve güvenilir inşaat çözümleri.',
    'keywords',         'inşaat, mimarlık, konut projeleri, ticari projeler, proje yönetimi, anahtar teslim, Sultan Defense',
    'og_image',         '',
    'og_type',          'website'
  ),
  NOW(3), NOW(3)
...
VALUES (
  UUID(),
  'sultandefense__site_apple_touch_icon',
  '*',
  JSON_OBJECT(
...
VALUES (
  UUID(),
  'sultandefense__site_og_default_image',
  '*',
  JSON_OBJECT(
...
VALUES (
  ...
  JSON_OBJECT(
    ...
    'email_2',          'proje@sultandefense.com',
...
VALUES (
  ...
  JSON_OBJECT(
    ...
    'phone_2',          '+90 532 310 00 00',
    'email',            'info@sultandefense.com',
    'email_2',          'projects@sultandefense.com',
