...
VALUES
-- HEADER ROOT
('dd010001-4001-4001-8001-dd0000000001', NULL, 'header', NULL, 'sultandefense', 'custom', NULL, NULL, 0, 1), -- Ana Sayfa
('dd010002-4002-4002-8002-dd0000000002', NULL, 'header', NULL, 'sultandefense', 'custom', NULL, NULL, 1, 1), -- Projeler
('dd010003-4003-4003-8003-dd0000000003', NULL, 'header', NULL, 'sultandefense', 'custom', NULL, NULL, 2, 1), -- Hizmetler
('dd010004-4004-4004-8004-dd0000000004', NULL, 'header', NULL, 'sultandefense', 'custom', NULL, NULL, 3, 1), -- Galeri
('dd010005-4005-4005-8005-dd0000000005', NULL, 'header', NULL, 'sultandefense', 'custom', NULL, NULL, 4, 1), -- Hakkımızda
('dd010006-4006-4006-8006-dd0000000006', NULL, 'header', NULL, 'sultandefense', 'custom', NULL, NULL, 5, 1), -- İletişim
('dd010007-4007-4007-8007-dd0000000007', NULL, 'header', NULL, 'sultandefense', 'custom', NULL, NULL, 6, 1), -- Teklif Al
...
('dd030001-4001-4001-8001-dd0000000001', NULL, 'footer', 'ee010001-4001-4001-8001-ee0000000001', 'sultandefense', 'custom', NULL, NULL, 0, 1), -- Ana Sayfa
('dd030002-4002-4002-8002-dd0000000002', NULL, 'footer', 'ee010001-4001-4001-8001-ee0000000001', 'sultandefense', 'custom', NULL, NULL, 1, 1), -- Projeler
('dd030003-4003-4003-8003-dd0000000003', NULL, 'footer', 'ee010001-4001-4001-8001-ee0000000001', 'sultandefense', 'custom', NULL, NULL, 2, 1), -- Hizmetler
('dd030004-4004-4004-8004-dd0000000004', NULL, 'footer', 'ee010001-4001-4001-8001-ee0000000001', 'sultandefense', 'custom', NULL, NULL, 3, 1), -- Galeri
('dd030005-4005-4005-8005-dd0000000005', NULL, 'footer', 'ee010001-4001-4001-8001-ee0000000001', 'sultandefense', 'custom', NULL, NULL, 4, 1), -- Hakkımızda
('dd030006-4006-4006-8006-dd0000000006', NULL, 'footer', 'ee010001-4001-4001-8001-ee0000000001', 'sultandefense', 'custom', NULL, NULL, 5, 1), -- İletişim

-- FOOTER: YASAL  (section = ee010002)
('dd040001-4001-4001-8001-dd0000000001', NULL, 'footer', 'ee010002-4002-4002-8002-ee0000000002', 'sultandefense', 'custom', NULL, NULL, 0, 1), -- Gizlilik Politikası
('dd040002-4002-4002-8002-dd0000000002', NULL, 'footer', 'ee010002-4002-4002-8002-ee0000000002', 'sultandefense', 'custom', NULL, NULL, 1, 1), -- KVKK
('dd040003-4003-4003-8003-dd0000000003', NULL, 'footer', 'ee010002-4002-4002-8002-ee0000000002', 'sultandefense', 'custom', NULL, NULL, 2, 1), -- Kullanım Koşulları
('dd040004-4004-4004-8004-dd0000000004', NULL, 'footer', 'ee010002-4002-4002-8002-ee0000000002', 'sultandefense', 'custom', NULL, NULL, 3, 1), -- Çerez Politikası

-- FOOTER: SOSYAL  (section = ee010003)
('dd050001-4001-4001-8001-dd0000000001', NULL, 'footer', 'ee010003-4003-4003-8003-ee0000000003', 'sultandefense', 'custom', NULL, 'instagram', 0, 1),
('dd050002-4002-4002-8002-dd0000000002', NULL, 'footer', 'ee010003-4003-4003-8003-ee0000000003', 'sultandefense', 'custom', NULL, 'linkedin', 1, 1)
...
-- FOOTER: SOSYAL
(UUID(), 'dd050001-4001-4001-8001-dd0000000001', 'tr', 'Instagram', 'https://www.instagram.com/sultandefense', NOW(3), NOW(3)),
(UUID(), 'dd050002-4002-4002-8002-dd0000000002', 'tr', 'LinkedIn', 'https://www.linkedin.com/company/sultandefense', NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
  `title`      = VALUES(`title`),
  `url`        = VALUES(`url`),
  `updated_at` = CURRENT_TIMESTAMP(3);
...
-- FOOTER: SOCIAL
(UUID(), 'dd050001-4001-4001-8001-dd0000000001', 'en', 'Instagram', 'https://www.instagram.com/sultandefense', NOW(3), NOW(3)),
(UUID(), 'dd050002-4002-4002-8002-dd0000000002', 'en', 'LinkedIn', 'https://www.linkedin.com/company/sultandefense', NOW(3), NOW(3))
ON DUPLICATE KEY UPDATE
  `title`      = VALUES(`title`),
  `url`        = VALUES(`url`),
  `updated_at` = CURRENT_TIMESTAMP(3);
