...
VALUES
  ('sa-brand-0001-0001-0001-000000000001', NULL, 'logo-light.svg', 'logo', 'branding/logo-light.svg', 'logo', 'image/svg+xml', 1807, NULL, NULL, '/uploads/logo/logo-light.svg', 'local', 'branding/logo-light.svg', 'image', 'svg', '{"label": "Sultan Defense Logo (Light)"}', NOW(3), NOW(3)),
  ('sa-brand-0002-0002-0002-000000000002', NULL, 'logo-dark.svg', 'logo', 'branding/logo-dark.svg', 'logo', 'image/svg+xml', 1807, NULL, NULL, '/uploads/logo/logo-dark.svg', 'local', 'branding/logo-dark.svg', 'image', 'svg', '{"label": "Sultan Defense Logo (Dark)"}', NOW(3), NOW(3)),
